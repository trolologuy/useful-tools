...
- [Useful Tools :mag_right:](#useful-tools-mag_right)
  - [Application Programming Interface (API) Development](#application-programming-interface-api-development)
  - [Backup / Data / Restoration / ...](#backup--data--restoration--)
  - [Blogs](#blogs)
  - [Banking](#banking)
  - [Bots / Chatbots / Telegram Bots](#bots--chatbots--telegram-bots)
  - [Browsers](#browsers)
  - [Calculus](#calculus)
  ...
  - [Craft](#craft)
  - [Code style, review, quality and security / Linters / Debugging](#code-style-review-quality-and-security--linters--debugging)
  - [Cheatsheets](#cheatsheets)
  - [Clustering](#clustering)
  - [Configuration Management](#configuration-management)
  - [Continuous Integration (CI) / Continuous Delivery (CD)](#continuous-integration-ci--continuous-delivery-cd)
  - [Databases - Related Stuff](#databases---related-stuff)
  - [Deployment / Automation / Browser Automation](#deployment--automation--browser-automation)
  - [Development](#development)
  - [Documentation / Wikis / User Feedback](#documentation--wikis--user-feedback)
  - [Docker / Kubernetes](#docker--kubernetes)
  - [Emulation](#emulation)
  - [Enterprise Ressource Planning (ERP) / Groupware / Customer Relationship Management (CRM) / Asset Management System](#enterprise-ressource-planning-erp--groupware--customer-relationship-management-crm--asset-management-system)
  - [File Sharing / data / downloader](#file-sharing--data--downloader)
  - [Frameworks / Snippets](#frameworks--snippets)
  - [Games / Game launchers](#games--game-launchers)
  - [Graphics / Design / Icons](#graphics--design--icons)
  - [Good Practices / Best Practices / Ebooks](#good-practices--best-practices--ebooks)
  - [Graphical User Interface (GUI) / Screens](#graphical-user-interface-gui--screens)
  - [Git](#git)
  - [Hardware Checks](#hardware-checks)
  - [Integrated Development Environment (IDE)](#integrated-development-environment-ide)
    - [Atom Plugins](#atom-plugins)
  - [Images / Image Optimisation](#images--image-optimisation)
  - [Images reverse search / Face search / Image tagging / Deepfake](#images-reverse-search--face-search--image-tagging--deepfake)
  - [Remote Desktop](#remote-desktop)
  - [Recruitment / Job searching / Interviews](#recruitment--job-searching--interviews)
  ...
  - [Massive open online course (MOOC) / E-Learning / Exercises / Educational Games](#massive-open-online-course-mooc--e-learning--exercises--educational-games)
  - [Monitoring / Logs / Server Management](#monitoring--logs--server-management)
  - [Movies / Films / Plex / Animes](#movies--films--plex--animes)
  - [Music](#music)
  - [Networking / DNS / Wifi ...](#networking--dns--wifi-)
  - [Operating Systems / Virtualization](#operating-systems--virtualization)
  - [Online Payment / Sell stuff / Buy stuff](#online-payment--sell-stuff--buy-stuff)
  - [Others](#others)
  - [Presentations](#presentations)
  - [Project management / Time Management / Organisation / Kanban](#project-management--time-management--organisation--kanban)
  - [Questions & Answers (Questions & Answers)](#questions--answers-questions--answers)
  - [Regex / Sed](#regex--sed)
  - [Remote work / Visioconference](#remote-work--visioconference)
  - [Selfhosted](#selfhosted)
  - [Server Basics](#server-basics)
  - [SSL](#ssl)
  - [Spectre / Meltdown](#spectre--meltdown)
  - [Screencast / Screenshots](#screencast--screenshots)
  - [Scrapping / Parsing](#scrapping--parsing)
  - [Security / Password Manager / Cracking](#security--password-manager--cracking)
  - [Server Management](#server-management)
  - [Shell / Terminal / Powershell / Command Line Interface (CLI)](#shell--terminal--powershell--command-line-interface-cli)
  - [System utilities](#system-utilities)
    - [Oh-my-zsh Theme](#oh-my-zsh-theme)
    - [Oh-my-zsh Plugins](#oh-my-zsh-plugins)
  - [Templates](#templates)
  - [Translations](#translations)
  - [User Management (LDAP / Radius / SSO / OpenID Connect / OAuth / SAML / ... )](#user-management-ldap--radius--sso--openid-connect--oauth--saml---)
  ...
  - [Website builder / CMS](#website-builder--cms)
  - [Website Analysis / Analytics](#website-analysis--analytics)
  - [Website Speedtest / Performance and Configuration analysis](#website-speedtest--performance-and-configuration-analysis)
  - [Writing / Markdown / Rendering](#writing--markdown--rendering)
  - [Wordpress](#wordpress)
...
Command-line tool that instantly fetches Stack Overflow results when an exception is thrown. - [![](https://img.shields.io/badge/pricing-open--source-green)](#)
...
* [i-doit](https://www.i-doit.org/) - Configuration and Management Database that allows to follow ITIL best practises - [![](https://img.shields.io/badge/pricing-open--source-green)](#)
...
for app and tool developers. Helps Generate config data. - [![](https://img.shields.io/badge/pricing-open--source-green)](#)
...
* [react-kanban](https://github.com/markusenglund/react-kanban) - A server-rendered React Kanban app inspired by Trello.
...
* [zeit](https://zeit.co/) - Cloud platform for static frontends and serverless functions. It enables developers to host websites and web applications that deploy instantly for example from a git repository, scale automatically, and require no supervision - [![](https://img.shields.io/badge/pricing-free-yellow)](#)
...
##  Project management / Time Management / Organisation / Kanban
...
* [react-kanban](https://github.com/markusenglund/react-kanban) - A Trello-like Kanban application built with React and Redux. - [![](https://img.shields.io/badge/pricing-open--source-green)](#)
...
## Security / Password Manager / Cracking
